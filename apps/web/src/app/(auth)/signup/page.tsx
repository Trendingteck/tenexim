            ...
            <div className="flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24 bg-white dark:bg-slate-950 relative">
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div className="mb-12">
                        ...
                        <h2 className="text-4xl font-bold text-slate-900 dark:text-white tracking-tight">Create Account</h2>
                        <p className="mt-3 text-sm font-medium text-slate-500 dark:text-slate-400">
                            Start your journey with global trade intelligence.
                        </p>
                    </div>

                    <form className="space-y-6" onSubmit={handleSignup}>
                        <div>
                            <label htmlFor="name" className="block text-xs font-bold uppercase tracking-widest text-slate-400 mb-2 ml-1">
                                Full Name
                            </label>
                            <div className="mt-1">
                                <input
                    ...
                    <p className="mt-12 text-center text-sm font-medium text-slate-500">
                        ...
                        <Link href="/login" className="font-bold text-amber-600 hover:text-amber-500 dark:text-amber-400">
                            Sign in
                        </Link>
                    </p>
                </div>
            ...
            <div className="hidden lg:block relative bg-slate-950 overflow-hidden">
                ...
                <div className="absolute bottom-24 left-16 right-16">
                    <blockquote className="text-2xl font-serif font-medium text-white leading-relaxed italic border-l-4 border-amber-500 pl-8">
                        "Join thousands of enterprises already leveraging TENEXIM's global trade intelligence platform."
                    </blockquote>
                </div>

                <div className="absolute top-12 right-12 p-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl">
                    <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Global Coverage</div>
                    <div className="text-xl font-bold text-white">218+</div>
                    <div className="text-xs font-bold text-emerald-500 uppercase">Countries</div>
                </div>
            </div>
        </div>
    );
